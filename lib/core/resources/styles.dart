...
class FungsitamaColors extends ThemeExtension<FungsitamaColors> {
  ...
  @override
  ThemeExtension<FungsitamaColors> copyWith({
    Color? background,
    Color? card,
    Color? buttonText,
    Color? subtitle,
  ...
  @override
  ThemeExtension<FungsitamaColors> lerp(
    covariant ThemeExtension<FungsitamaColors>? other,
    double t,
  ) {
    if (other is! FungsitamaColors) {
      return this;
    }
    return FungsitamaColors(
...
class BoxShadows {
  ...
  BoxShadow get button => BoxShadow(
    color: Theme.of(
      context,
    ).extension<FungsitamaColors>()!.shadow!.withValues(alpha: 0.5),
    blurRadius: 16.0,
    spreadRadius: 1.0,
  );
  ...
  BoxShadow get dialog => BoxShadow(
    color: Theme.of(context).extension<FungsitamaColors>()!.shadow!,
