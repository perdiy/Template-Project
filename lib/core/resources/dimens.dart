...
class Dimens {
  ...
  static double profilePicture = 48.w;
  static double bigProfilePicture = 68.w;
  static double birthdayCalendar = 120.w;
  static double cameraFaceRecognition = 250.w;
  static double underConstruction = 200.w;

  static double buttonH = 40.w;
  static double imageW = 110.w;
  static double datePicker = 400.w;

  static double buttonRadius = 6.w;
  static double cardRadius = 12.w;
  static double cardRatio = 1.5.w;
  static double cornerRadius = 10.w;
  static double cornerRadiusBottomSheet = 30.w;
}
