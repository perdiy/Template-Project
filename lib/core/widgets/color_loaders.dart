            ...
            child: Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Dot(radius: dotRadius, color: Palette.subTextDark),
                ),
                Transform.translate(
                  offset: Offset(
                ...
                Transform.translate(
                  ...
                  child: Dot(
                    ...
                    color: Theme.of(
                      context,
                    ).extension<FungsitamaColors>()!.yellow,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    ...
                    color: Theme.of(
                      context,
                    ).extension<FungsitamaColors>()!.blue,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    ...
                    color: Theme.of(
                      context,
                    ).extension<FungsitamaColors>()!.flamingo,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    ...
                    color: Theme.of(
                      context,
                    ).extension<FungsitamaColors>()!.lavender,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    ...
                    color: Theme.of(
                      context,
                    ).extension<FungsitamaColors>()!.pink,
                  ),
                ),
              ],
            ),
