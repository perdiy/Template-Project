...
enum Religion { islam, kristen, hindu, buddha, konghucu }

enum MaritalStatus { single, mariage, widow }

enum LeaveType { medical, emergency, other }

enum ReimbursementType { travel, medical, operational }

enum PeriodLeave { fullDay, halfDay }
...
mixin class MainBoxMixin {
  ...
  static const _boxName = 'hris_app';
